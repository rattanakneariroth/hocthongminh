        ...
        <div style={{height: '400px', overflow: 'hidden', backgroundImage: "url('https://hocthongminh.com/images/event_bg_bottom.png')"}}>
            ...
            <div className="text-center p-10  " >
                ...
                <div className="grid grid-cols-3 gap-3 justify-evenly px-16 ">
                    <button className="bg-slate-50 bg-transparent hover:bg-teal-500 text-black font-semibold hover:text-white py-4  border-2 border-black hover:border-transparent rounded">
                    Đề Thi ĐGNL ĐHQG Hà Nội</button>
                    <button className="bg-slate-50 bg-transparent hover:bg-teal-500 text-black font-semibold hover:text-white py-3  border-2 border-black hover:border-transparent rounded">
